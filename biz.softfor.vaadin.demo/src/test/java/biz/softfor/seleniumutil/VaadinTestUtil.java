...
public class VaadinTestUtil {
  ...
  throws IOException {
    ...
    drvHlpr.wait.until(drv -> drv.findElement(By.id(MainLayout.logoutId)) != null);
  }
  ...
  public static void sideNavSectionClick(DriverHlpr drvHlpr, String name) {
    ...
    sectShadowRoot.findElement(By.cssSelector("div:nth-child(1)")).click();
  }

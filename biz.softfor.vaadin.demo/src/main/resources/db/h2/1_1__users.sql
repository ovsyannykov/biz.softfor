...
--ADMIN
 (1, (SELECT id from roles WHERE objName='biz.softfor.address.jpa.Country' AND updateFor=0))
,(1, (SELECT id from roles WHERE objName='biz.softfor.address.jpa.Country' AND updateFor=1))
--MANAGER
,(2, (SELECT id from roles WHERE objName='biz.softfor.address.jpa.Country' AND updateFor=0))
--CITIES_EDITORS
...
--STATES_EDITORS
,(6, (SELECT id from roles WHERE objName='biz.softfor.address.jpa.State' AND updateFor=0))
,(6, (SELECT id from roles WHERE objName='biz.softfor.address.jpa.State' AND updateFor=1))
,(6, (SELECT id from roles WHERE objName='biz.softfor.address.jpa.State.name' AND updateFor=0))
,(6, (SELECT id from roles WHERE objName='biz.softfor.address.jpa.State.name' AND updateFor=1))
;

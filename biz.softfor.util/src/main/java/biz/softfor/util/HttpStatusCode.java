...
/**https://stackoverflow.com/a/66219005*/
public enum HttpStatusCode {
  ...
  UNKNOWN_STATUS_CODE(1000, "Unknown status code");

  private static HttpStatusCode[] values = values();
  ...
  private HttpStatusCode(int value, String description) {
    this.value = value;

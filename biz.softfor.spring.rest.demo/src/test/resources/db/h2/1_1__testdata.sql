...
,(0,0,0,1,'biz.softfor.partner.jpa.ContactDetails',roleId(1,'biz.softfor.partner.jpa.ContactDetails',0),'ContactDetails (update)','biz.softfor.partner.jpa ContactDetails (update)')
...
,(1,(SELECT id from roles WHERE objName='biz.softfor.partner.jpa.ContactDetails' AND updateFor=1))

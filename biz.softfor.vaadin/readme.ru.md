...
языка интерфейса из списка, задаваемого в настройках. Пример использования:
...
<img src="doc/images/DateDbGridColumn.png" alt="DateDbGridColumn">
...
<img src="doc/images/ComboBoxDbGridColumn.png" alt="ComboBoxDbGridColumn">
...
В отличие от DbGrid работает с предварительно считанными данными. Пример
использования:
